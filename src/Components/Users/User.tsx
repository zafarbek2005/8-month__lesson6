...
const User = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get('http://dummyjson.com/users?limit=4&skip');
